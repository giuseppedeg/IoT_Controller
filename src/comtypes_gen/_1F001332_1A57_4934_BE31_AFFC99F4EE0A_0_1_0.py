...
__all__ = [
    'PortableDevice', 'IPortableDevicePropVariantCollection',
    'tagCACY', '__MIDL_IOleAutomationTypes_0004', '_BYTE_SIZEDARR',
    'tagCADATE', 'tagCAUB', 'IPortableDeviceResources',
    '__MIDL_IOleAutomationTypes_0005', '_HYPER_SIZEDARR',
    'tagBSTRBLOB', 'Library', '_LONG_SIZEDARR', 'tagCADBL',
    '__MIDL_IOleAutomationTypes_0006', '_SHORT_SIZEDARR',
    'typelib_path', '_wireVARIANT',
    'IPortableDeviceServiceCapabilities', 'IPortableDeviceManager',
    'IPropertyStore', 'tagCABSTRBLOB', 'tagCABOOL', 'tagCAFILETIME',
    'IPortableDeviceWebControl', '_wireSAFEARR_BRECORD',
    'IPortableDeviceValues', 'tagCAI', 'tagCALPWSTR',
    'IPortableDeviceServiceMethods', 'tagSTATSTG', '_tagpropertykey',
    'tagCAFLT', 'IPortableDeviceValuesCollection',
    'PortableDeviceFTM', 'tagCASCODE', 'IStream', '_wireSAFEARR_BSTR',
    'tagCAPROPVARIANT', 'IPortableDeviceServiceMethodCallback',
    'tagCAL', 'tagCAUH', 'IPortableDeviceProperties',
    'PortableDeviceDispatchFactory', 'IPortableDeviceContent',
    'IPortableDevice', 'tagCLIPDATA', '_wireSAFEARR_UNKNOWN',
    'IPortableDeviceService', 'tagCALPSTR',
    'IPortableDeviceKeyCollection', 'IPortableDeviceCapabilities',
    '_wireSAFEARRAY', 'PortableDeviceManager',
    'PortableDeviceWebControl', 'tagVersionedStream',
    'IPortableDeviceDispatchFactory', 'tag_inner_PROPVARIANT',
    '_FLAGGED_WORD_BLOB', 'tagCAUL', 'IStorage',
    'IPortableDeviceEventCallback', 'PortableDeviceService',
    'tagCACLIPDATA', '__MIDL_IOleAutomationTypes_0001',
    'IEnumPortableDeviceObjectIDs', 'IPortableDeviceContent2',
    'tagRemSNB', 'tagBLOB', '_wireSAFEARRAY_UNION', 'tagCACLSID',
    'tagCABSTR', '__MIDL___MIDL_itf_PortableDeviceApi_0001_0000_0001',
    '_wireSAFEARR_DISPATCH', '_wireBRECORD', 'tagCAUI', 'tagCAC',
    'tagCAH', 'IEnumSTATSTG', 'wireSNB', '_wireSAFEARR_HAVEIID',
    'PortableDeviceServiceFTM', '_wireSAFEARR_VARIANT',
    'wirePSAFEARRAY'
]

_check_version('1.4.8', 1727262389.971379)
